...
alias ll='ls -alF --color=auto -lAF'
alias la='ls -A --color=auto -laAF'
...
alias exit='history -c && history -w && exit'
alias poweroff='history -c && history -w && poweroff'
alias reboot='history -c && history -w && reboot'
